...
<div class="max-w-2xl">
    <div class="card p-6">
        <div class="flex items-center gap-3 mb-6 pb-4 border-b border-gray-100">
            ...
            <h2 class="text-base font-bold text-gray-800">Nuevo Medicamento</h2>
        </div>
        ...
        <form action="{{ route('medicamentos.store') }}" method="POST" class="space-y-5">
            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" name="codigo" value="{{ old('codigo') }}" class="form-input" placeholder="MED001" required>
                </div>
                <div>
                    <label class="form-label">Precio (S/) <span class="text-red-500">*</span></label>
                    <input type="number" name="precio" value="{{ old('precio') }}" class="form-input" placeholder="0.00" step="0.01" min="0" required>
                </div>
            </div>

            <div>
                <label class="form-label">Nombre del Medicamento <span class="text-red-500">*</span></label>
                <input type="text" name="nombre" value="{{ old('nombre') }}" class="form-input" placeholder="Ej: Paracetamol 500mg" required>
            </div>

            <div>
                <label class="form-label">Principio Activo <span class="text-red-500">*</span></label>
                <input type="text" name="principio_activo" value="{{ old('principio_activo') }}" class="form-input" placeholder="Ej: Acetaminofén" required>
            </div>

            <div>
                <label class="form-label">Stock inicial <span class="text-red-500">*</span></label>
                <input type="number" name="stock" value="{{ old('stock', 0) }}" class="form-input" placeholder="0" min="0" required>
            </div>
            ...
            <div class="flex gap-3 pt-2">
                <button type="submit" class="btn-primary">Registrar Medicamento</button>
